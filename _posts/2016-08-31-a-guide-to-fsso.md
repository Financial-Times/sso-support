...
1. [I can’t join my local federation as they only currently allow education or research institutions. What are my options?](#i-cant-join-my-local-federation-as-they-only-currently-allow-education-or-research-institutions-to-join-what-are-my-options)
1. [Once I am a member of Access Federation, how do I get set up to access FT content?](#i-cant-join-my-local-federation-as-they-only-currently-allow-education-or-research-institutions-to-join-what-are-my-options)
...
1. [How are SSO users deprovisioned?](#how-are-sso-users-deprovisioned)
1. [How are SSO users reprovisioned?](#how-are-sso-users-reprovisioned)
...
1. [Is SSO dependent on IP address?](#is-sso-dependent-on-ip-address)
1. [Does the FT provide mobile SSO?](#does-the-ft-provide-mobile-sso)
